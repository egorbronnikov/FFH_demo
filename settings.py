...
SESSION_CONFIGS = [
    ...
    dict(
        name='trust_repeated',
        display_name="trust_repeated",
        app_sequence=['trust_repeated'],
        num_demo_participants=2,
    ),
    dict(
        name='prisoner_repeated',
        display_name="prisoner_repeated",
        app_sequence=['prisoner_repeated'],
        num_demo_participants=2,
    ),
    dict(
        name='signal_game',
        display_name="signal_game",
        app_sequence=['signal_game'],
        num_demo_participants=2,
    ),
    dict(
        name='DG_with_shock_EE',
        display_name="DG_with_shock_EE",
        app_sequence=['DG_with_shock_EE'],
        num_demo_participants=2,
    ),
    dict(
        name='flipping_coin',
        display_name="flipping_coin",
        app_sequence=['flipping_coin'],
        num_demo_participants=2,
    ),
    # dict(
    #     name='DG_with_shock_Baseline',
    #     display_name="DG_with_shock(Baseline)",
    #     app_sequence=['DG_with_shock(Baseline)'],
    #     num_demo_participants=2,
    # ),
    # dict(
    #     name='pdg_nice',
    #     display_name="pdg_nice",
    #     app_sequence=['pdg_nice'],
    #     num_demo_participants=2,
    # ),
    # dict(
    #     name='display_image',
