...
class Constants(BaseConstants):
    name_in_url = 'FFH_Team_No_Info'
    players_per_group = 2
    num_rounds = 1
    endowment = 100
    instructions_0 = 'FFH_Team_No_Info/Instructions_0.html'
    instructions_1 = 'FFH_Team_No_Info/Instructions_1.html'
...
class Player(BasePlayer):
    ...
    gender = models.StringField(
        choices=[['Мужской', 'Мужской'],
                 ['Женский', 'Женский'],
                 ['Предпочитаю не говорить', 'Предпочитаю не говорить']],
...
def artists_choices(player: Player):
    choices = [(0, "Пьер Ренуap"), (1, "Клод Моне")]
